...
### Вывод:
 OpenMP ускоряет перемножение матриц равномерно, увеличивая процентный прирост по скорости с увеличением числа элементов матриц, на размере 3000 прирост достигает 20 раз. На размерах до 200 ускорения нет из-за накладных расходов на создание потоков и конкуренции за память.
